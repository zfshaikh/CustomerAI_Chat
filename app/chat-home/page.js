...
export default function Home() {
	...
	const teamMembers = [
		...
		{ name: 'Chialin Hsiao', role: 'Developer', image: '/teamImages/Chialin.png' },
					...
					<Stack sx={{ mt: 0 }} spacing={2}>
						...
						{teamMembers.map((member, index) => (
							...
							>
								...
								/>
								<Box>
									<Typography sx={{ fontWeight: 'bold', color: '#002884' }}>{member.name}</Typography>
              ...
              Logout
				...
				>
					...
					<DialogContent sx={{ padding: '20px', textAlign: 'center' }}>
						<Typography sx={{ fontSize: '18px', color: '#555', mt: 2 }}>Are you sure you want to log out?</Typography>
					</DialogContent>
